...
public class ColumnPool4 : MonoBehaviour {
    public static ColumnPool4 instance;
    ...
    private float spawnYPosition = -5;
    ...
    void Start() {
        ...
        //columns[0] = (GameObject)Instantiate(obstacle[0], objectPoolPosition, Quaternion.identity);
